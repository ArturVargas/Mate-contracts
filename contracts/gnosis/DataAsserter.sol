...
contract DataAsserter {
    ...
    constructor(address _defaultCurrency, address _optimisticOracleV3) {
        defaultCurrency = IERC20(_defaultCurrency); // DAI 0x44fA8E6f47987339850636F88629646662444217
        oo = OptimisticOracleV3Interface(_optimisticOracleV3); // 0x22A9AaAC9c3184f68C7B7C95b1300C4B1D2fB95C
